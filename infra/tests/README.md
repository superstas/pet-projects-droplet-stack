...
pytest infra/tests/test_domain_sanitization.py

# Run with verbose output
pytest infra/tests/ -v

# Run with hypothesis statistics
pytest infra/tests/ -v --hypothesis-show-statistics
```
...
**Location:** `infra/tests/bats/*.bats`

**Installation:**
```bash
./infra/tests/setup-bats.sh
```
...
# Run specific test file
./infra/tests/bats/bats-core/bin/bats infra/tests/bats/test_config_validation.bats
```
